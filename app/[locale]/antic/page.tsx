  ...
  return (
    <>
      <InViewSection
        ...
        style={{ backgroundImage: "url(/plastika.JPG)" }}
      >
      ...
      <InViewSection className="py-16 px-4 md:px-8 lg:px-16 flex flex-col lg:flex-row items-center gap-6">
        ...
        <div className="basis-1 lg:basis-[70%]">
          <Image src={'/anticHero.JPG'} alt="Antic collection" width={1920} height={100} className="shadow-xl" />
        </div>
      </InViewSection>

      <InViewSection className="py-16 px-4 md:px-8 lg:px-16 flex flex-col lg:flex-row items-center gap-6">
        <div className="basis-1 lg:basis-[70%] order-2 lg-order-1">
          <Image src={'/tomeAntic.JPG'} alt="Pero walking over LeBron — inspired design" width={1920} height={100} className="shadow-xl" />
        </div>
